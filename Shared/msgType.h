...
enum class MsgType : quint16 {
    ...
    //好友管理相关
    REQUEST_ADD_FRIEND = 0x0040, REQUEST_ADD_FRIEND_AGREED, //好友同意
    REQUEST_ADD_FRIEND_DECLINED, //好友拒绝
    REQUEST_ALL_FRIEND_LIST,    //获取好友列表
    REQUEST_ADD_FRIEND_ERROR_FRIEND_NOT_EXIST,
    REQUEST_ADD_FRIEND_ERROR_FRIENDSHIP_EXIST,
    REQUEST_ADD_FRIEND_ERROR_FRIEND_OFFLINE,
